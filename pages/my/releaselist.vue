<template>
  <view v-cloak>
    ...
    <view class="swiper-tab">
      <view :class="'swiper-tab-list ' + (currentTab==0 ? 'on' : '')" data-current="0" @tap="swichNav">已发布
        <view class="navBtm"></view>
      </view>
      <view :class="'swiper-tab-list ' + (currentTab==1 ? 'on' : '')" data-current="1" @tap="swichNav">已暂停
        <view class="navBtm"></view>
      </view>
      <view :class="'swiper-tab-list ' + (currentTab==2 ? 'on' : '')" data-current="2" @tap="swichNav">审核中
        <view class="navBtm"></view>
      </view>
      <view :class="'swiper-tab-list ' + (currentTab==3 ? 'on' : '')" data-current="3" @tap="swichNav">未通过
        <view class="navBtm"></view>
      </view>
    </view>
    ...
    <swiper :current="currentTab" class="swiper-box" duration="300"
        ...
        <view v-if='datalist.length>0'>
          <view v-for="(item, index) in datalist" :key="index" class="shoplist">
            <view class="missonbg">
              ...
              <view class="btnpos" @click="getrelease(item.id,1)">进行中</view>
            </view>
          </view>
        </view>
        ...
        <view v-if='datalist.length>0'>
          <view v-for="(item, index) in datalist" :key="index" class="shoplist">
            <view class="missonbg">
              ...
              <view class="btnpos" @click="getrelease(item.id,2)">奖励上限</view>
            </view>
          </view>
        </view>
        ...
        <view v-if='datalist.length>0'>
          <view v-for="(item, index) in datalist" :key="index" class="shoplist">
            <view class="missonbg">
              ...
              <view class="btnpos" @click="getrelease(item.id,3)">审核中</view>
            </view>
          </view>
        </view>
      </swiper-item>
      <swiper-item>
        ...
        <view v-if='datalist.length>0'>
          <view class="shoplist" v-for="(item, index) in datalist" :key="index">
            <view class="missonbg1">
              ...
              <view class="btnpos1" @click="getrelease(item.id,4)">整改发布</view>
              <view class="refused">
                <view>查看被拒原因</view>
...
getrelease(id,type){
  uni.navigateTo({
    url:'/pages/teambox/release1?id='+id+'&type='+type
  })
},
      refusedtrue(e) {
