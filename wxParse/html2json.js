  ...
  HTMLParser(html, {
    start: function (tag, attrs, unary) {
      ...
      if (node.tag === 'img') {
        ...
        var imgUrl = 'https://oa.zhigoukeji.com' + node.attr.src;
      ...
      if (node.tag === 'source') {
        results.source = 'https://oa.zhigoukeji.com' + node.attr.src;
      }
      ...
      if (node.tag === 'video') {
        node.attr.src = 'https://oa.zhigoukeji.com' + node.attr.src;
      }
